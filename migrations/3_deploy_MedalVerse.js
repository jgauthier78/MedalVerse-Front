...
module.exports = async function (deployer) {
  ...
  /*
    ...
    MVerse.addNewUser(accounts[0], "2.jpeg", "François Coste", "fcoste@gmail.com", 4, 0, { from: accounts[0] })
    await MVerse.addOrganization(accounts[1], "FFA", "Fédération Française d'Athlétisme", "A.jpg", { from: accounts[0] });
    await MVerse.addOrganization(accounts[0], "FFE", "Fédération Française d'Escrime", "B.jpg", { from: accounts[0] });
    await MVerse.organizationAddAdmin(0, accounts[0]);
