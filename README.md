...
|DOCUMENT|FICHIER|
|---:|:---|
|design_patterns.md|[design_patterns.md](documents/design_patterns.md)|
|Audit de sécurité|[avoiding_common_attacks.md](documents/avoiding_common_attacks.md)|
|Optimisations utilisées|[Optimisations.md](documents/Optimisations.md)
|Tests|[test_explanation.md](documents/test_explanation.md)|
|Liste des codes d'erreur|[Error_Code.md](documents/Error_Code.md)|
|Adresse de déploiement|[deployed_addresses.md](documents/deployed_addresses.md)|
